  ...
  return (
    ...
    <div class="lg:flex items-center justify-center w-full">
        <div tabindex="0" aria-label="card 1" class="focus:outline-none lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 bg-white p-6 shadow rounded">
            <div class="flex items-center border-b border-gray-200 pb-6">
                ...
                <div class="flex items-start justify-between w-full">
                    <div class="pl-3 w-full">
                        <p tabindex="0" class="focus:outline-none text-xl font-medium leading-5 text-gray-800">Adrian C</p>
                        <p tabindex="0" class="focus:outline-none text-sm leading-normal pt-2 text-gray-500">Member ID# 01</p>
                    </div>
            ...
            <div class="px-2">
                <p tabindex="0" class="focus:outline-none text-sm leading-5 py-4 text-gray-600">Age / hobbies / location / join date</p>
                <div tabindex="0" class="focus:outline-none flex">
                    <button class="py-2 px-4 text-xs leading-3 text-indigo-700 rounded-full bg-indigo-100">User Phone number</button>
                    <button class="py-2 px-4 ml-3 text-xs leading-3 text-indigo-700 rounded-full bg-indigo-100">User email</button>
                </div>
            </div>
        </div>
        </div>
